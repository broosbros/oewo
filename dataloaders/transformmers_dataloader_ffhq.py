...
def process_images_in_batches(
    ...
    hr_low_freq_dir = os.path.join(output_dir, "HR_low_freq")
    hr_high_freq_dir = os.path.join(output_dir, "HR_high_freq")
    lr_low_freq_dir = os.path.join(output_dir, "LR_low_freq")
    lr_high_freq_dir = os.path.join(output_dir, "LR_high_freq")
