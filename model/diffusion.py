...
from transformer import FrequencyDecompositionTransformer
...
class GaussianDiffusion(nn.Module):
    ...
    def __init__(
        ...
        self.cnn = FrequencyDecompositionTransformer(scale_factor=4)
        ...
        # )
        # self.cnn.eval()
        # Instead of this include cnn weights
    ...
    def p_losses(self, x_in, noise=None):
        # Extract low and high frequency images from transformer output
        transformer_output = x_in["SR"]
        low_frequency_image, high_frequency_image = transformer_output

        x_start = x_in["HR"] - high_frequency_image
        ...
        if not self.conditional:
            ...
            x_recon = self.denoise_fn(
                torch.cat([low_frequency_image, high_frequency_image, x_noisy], dim=1),
